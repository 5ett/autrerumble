...
class SignUp(FlaskForm):
    ...
    email = StringField('email', validators=[DataRequired(),Email('make sure you typed a correct email')])
...
class UpdateProf(FlaskForm):
    ...
    def validate_email(self, email):
        if email.data != current_user.email:
            ...
            if check:
                raise ValidationError('this is either your old email or someone else is using it')
            elif email.errors:
